...
namespace SchoolManagement2.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Lecturer_Id,firstname,lastname")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Lecturer_Id,firstname,lastname")] Lecturer lecturer)
        {
            if (ModelState.IsValid)
            {
